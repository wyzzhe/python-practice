...
"ai_position_3d": { // 商品在3D空间中的预估位置（相对坐标）（归一化坐标0-1）示例：,}
"x": 0, // X轴归一化坐标：左右方向（左负右正）,示例"x":-0.11774091445695634
"y": 0, // Y轴归一化坐标：上下方向（下负上正）,示例"y":0.9930443479839356,
"z": 0 // Z轴归一化坐标：前后方向（后负前正）,示例"z":0
},
...
只有is_recommended为true的商品才需要计算position_3d
